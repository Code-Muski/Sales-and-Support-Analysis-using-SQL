...
and 
Column_Name in ('AGENT_CODE', 'AGENT_NAME', 'WORKING_AREA', 'COMMISSION', 'PHONE_NO', 'COUNTRY'
				'CUST_CODE', 'CUST_NAME', 'CUST_CITY', 'WORKING_AREA', 'CUST_COUNTRY', 'GRADE', 'OPENING_AMT', 'RECEIVE_AMT', 'PAYMENT_AMT', 'OUTSTANDING_AMT', 
                'PHONE_NO', 'AGENT_CODE',
				'ORD_NUM', 'ORD_AMOUNT', 'ADVANCE_AMOUNT', 'ORD_DATE', 'CUST_CODE', 'AGENT_CODE', 'ORD_DESCRIPTION') order by Column_Name;
...
Column_Name in ('AGENT_CODE', 'AGENT_NAME', 'WORKING_AREA', 'COMMISSION', 'PHONE_NO', 'COUNTRY'
				'CUST_CODE', 'CUST_NAME', 'CUST_CITY', 'WORKING_AREA', 'CUST_COUNTRY', 'GRADE', 'OPENING_AMT', 'RECEIVE_AMT', 'PAYMENT_AMT', 'OUTSTANDING_AMT', 
                'PHONE_NO', 'AGENT_CODE',
				'ORD_NUM', 'ORD_AMOUNT', 'ADVANCE_AMOUNT', 'ORD_DATE', 'CUST_CODE', 'AGENT_CODE', 'ORD_DESCRIPTION') AND CONSTRAINT_NAME = 'PRIMARY' order by Column_Name;
